  ...
  describe("Overload resolution", () => {
    ...
    describe("Overall priority", () => {
      ...
      it("Prefers arrays to structs and tuples", async () => {
        const { abi, tx } = await encoder.resolveAndEncode("overloaded", [["0xff"]], {
          allowOptions: true
        });
      ...
      it("Prefers bytestrings to numeric types", async () => {
        const { abi, tx } = await encoder.resolveAndEncode("overloaded", ["0xffff"], {
          allowOptions: true
        });
        assert.lengthOf(abi.inputs, 1);
        assert.strictEqual(abi.inputs[0].type, "bytes32");
      ...
      it("Prefers (non-enum) numbers to enums", async () => {
        const { abi, tx } = await encoder.resolveAndEncode("overloaded", [1], {
          allowOptions: true
        });
        assert.lengthOf(abi.inputs, 1);
      ...
      it("Prefers enums to strings", async () => {
        const { abi, tx } = await encoder.resolveAndEncode("overloaded", ["Red"], {
          allowOptions: true
        });
        assert.lengthOf(abi.inputs, 1);
        assert.strictEqual(abi.inputs[0].type, "uint8");
      ...
      it("Prefers strings to bools", async () => {
        const { abi, tx } = await encoder.resolveAndEncode("overloaded", [""], {
          allowOptions: true
        });
        assert.lengthOf(abi.inputs, 1);
      ...
      it("Prefers numbers to strings", async () => {
        const { abi, tx } = await encoder.resolveAndEncode("overloaded", ["256"], {
          allowOptions: true
        });
        assert.lengthOf(abi.inputs, 1);
        assert.strictEqual(abi.inputs[0].type, "uint256");
    ...
    describe("Array priority", () => {
      it("Prefers static length to dynamic length", async () => {
        const { abi, tx } = await encoder.resolveAndEncode("overloadedArray", [[256, 256]], {
          allowOptions: true
        });
        assert.lengthOf(abi.inputs, 1);
      ...
      it("Prefers more specific base type", async () => {
        const { abi, tx } = await encoder.resolveAndEncode("overloadedArray", [[1]], {
          allowOptions: true
        });
        assert.lengthOf(abi.inputs, 1);
        assert.strictEqual(abi.inputs[0].type, "uint8[]");
      ...
      it("Falls back on less specific type if necessary", async () => {
        const { abi, tx } = await encoder.resolveAndEncode("overloadedArray", [[256]], {
          allowOptions: true
        });
        assert.lengthOf(abi.inputs, 1);
        assert.strictEqual(abi.inputs[0].type, "uint256[]");
      ...
      it("Rejects if no unique best overload", async () => {
        try {
          await encoder.resolveAndEncode("overloadedArray", [[1, 1]], {
            allowOptions: true
          });
    ...
    describe("Struct priority", () => {
      ...
      it("Rejects if no unique best overload", async () => {
        try {
          await encoder.resolveAndEncode("overloadedStruct", [{ x: 1, y: 1 }], {
            allowOptions: true
          });
          assert.fail("Should reject if no unique best");
        } catch (error) {
    ...
    describe("Multiple argument priority", () => {
      it("Prefers more specific components to less specific components", async () => {
        const { abi, tx } = await encoder.resolveAndEncode("overloadedMulti", [1, 256], {
          allowOptions: true
        });
      ...
      it("Falls back on less specific type if necessary", async () => {
        const { abi, tx } = await encoder.resolveAndEncode("overloadedMulti", [256, 256], {
          allowOptions: true
        });
        assert.lengthOf(abi.inputs, 2);
        assert.strictEqual(abi.inputs[0].type, "uint256");
      ...
      it("Rejects if no unique best overload", async () => {
        try {
          await encoder.resolveAndEncode("overloadedMulti", [1, 1], { allowOptions: true });
          assert.fail("Should reject if no unique best");
        } catch (error) {
          if (error.name !== "NoUniqueBestOverloadError") {
            throw error;
    ...
    describe("Bytes priority", () => {
      it("Prefers shorter length to longer length", async () => {
        const { abi, tx } = await encoder.resolveAndEncode("overloadedBytes", ["0xff"], {
          allowOptions: true
        });
        assert.lengthOf(abi.inputs, 1);
        assert.strictEqual(abi.inputs[0].type, "bytes1");
      ...
      it("Prefers static to dynamic", async () => {
        const { abi, tx } = await encoder.resolveAndEncode("overloadedBytes", ["0xf00f"], {
          allowOptions: true
        });
        assert.lengthOf(abi.inputs, 1);
    ...
    describe("Numeric priority", () => {
      it("Prefers uint8 to int16", async () => {
        const { abi, tx } = await encoder.resolveAndEncode("overloadedNumeric", [128], {
          allowOptions: true
        });
        assert.lengthOf(abi.inputs, 1);
        assert.strictEqual(abi.inputs[0].type, "uint8");
      ...
      it("Prefers int8 to int16", async () => {
        const { abi, tx } = await encoder.resolveAndEncode("overloadedNumeric", [-1], {
          allowOptions: true
        });
        assert.lengthOf(abi.inputs, 1);
      ...
      it("Falls back on int16 if necessary", async () => {
        const { abi, tx } = await encoder.resolveAndEncode("overloadedNumeric", [-129], {
          allowOptions: true
        });
        assert.lengthOf(abi.inputs, 1);
      ...
      it("Won't choose between int8 and uint8", async () => {
        try {
          await encoder.resolveAndEncode("overloadedNumeric", [1], { allowOptions: true });
          assert.fail("Should reject if no unique best");
        } catch (error) {
          if (error.name !== "NoUniqueBestOverloadError") {
            throw error;
