  ...
  async interpreter(cmd) {
    ...
    switch (cmd) {
      ...
      case "v":
        ...
        //note: the processes to set up section printouts are the same as those in case "p"
        const tempPrintouts = this.updatePrintouts(splitArgs, this.printer.sections, this.printer.sectionPrintouts);
      ...
      case "p":
        ...
        //note: the processes to set up location printouts are the same as those in case "v"
        const temporaryPrintouts = this.updatePrintouts(splitArgs, this.printer.locations, this.printer.locationPrintouts);
